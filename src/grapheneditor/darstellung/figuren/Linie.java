 ...
 * @author Axel
 */
public class Linie implements Shape, Serializable {
...
//    private float l;
//    private float b;
    private int linienTyp;
//    private double l2;
    
    public Linie(Point2D p1, Point2D p2) {
//        this(p1, p2);
//        this(p1, p2, 75, 50, 0);
    	this.p1 = p1;
    	this.p2 = p2;
...
//    public Linie(double x1, double y1, double x2, double y2, int l, int b, int typ) {
...
//    }
    ...
    public void setLinie(Point2D p1, Point2D p2) {
        this.p1 = p1;
        this.p2 = p2;
        erstelleWeg();
    }
